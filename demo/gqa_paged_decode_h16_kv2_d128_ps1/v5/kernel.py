...
def _gqa_paged_decode_kernel(
    ...
    for page_idx in range(n_pages):
        ...
        scale_0 = tl.math.exp2((m_0 - m_new_0) * log2e)
        exp_s_0 = tl.math.exp2((s_0 - m_new_0) * log2e)
        l_0 = l_0 * scale_0 + exp_s_0
        m_0 = m_new_0
        acc_0 = acc_0 * scale_0 + exp_s_0 * v

        # Q-head 1
        qk_1 = tl.sum(q_1 * k)
        s_1 = qk_1 * sm_scale
        m_new_1 = tl.maximum(m_1, s_1)
        scale_1 = tl.math.exp2((m_1 - m_new_1) * log2e)
        exp_s_1 = tl.math.exp2((s_1 - m_new_1) * log2e)
        l_1 = l_1 * scale_1 + exp_s_1
        m_1 = m_new_1
        acc_1 = acc_1 * scale_1 + exp_s_1 * v
